...
from transformers.models.whisper.modeling_whisper import ACT2FN, WHISPER_ATTENTION_CLASSES, WhisperConfig, WhisperEncoder
...
from .configuration_minicpm_o_2_6 import SiglipVisionConfig, ConditionalChatTTSConfig, MiniCPM_o_2_6Config
